...
import com.effitizer.start.exception.BadRequestException;
import com.effitizer.start.util.CookieUtils;
...
/**
 * oauth2인증이 성공한 후에 실행되어 프론트엔드를 통해서 들어온 redirect-uri가 저장해놓은 app.redirect-uris의 항목과 일치하는지 확인 후, 일치한다면 token을 포함한 uri 생성하여 인증요청 쿠키를 비워주고 redirect
 */
@Component
